...
class PaginatedDataTable3 extends StatefulWidget {
  ...
  /// particular [PaginatedDataTable3] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [PaginatedDataTable3]
  ...
  /// To modify the border or background color of the [PaginatedDataTable3], use
  ...
  /// [PaginatedDataTable3] widget itself; it should be reused each time the
  /// [PaginatedDataTable3] constructor is called.
  ...
  @override
  PaginatedDataTable3State createState() => PaginatedDataTable3State();
}

/// Holds the state of a [PaginatedDataTable3].
///
/// The table can be programmatically paged using the [pageTo] method.
class PaginatedDataTable3State extends State<PaginatedDataTable3> {
  ...
  @override
  void didUpdateWidget(PaginatedDataTable3 oldWidget) {
